		...
		try
		{
			...
			while ( true )
			{
				...
				else if ( answer.equals ("5") )
				{
					...
					Transaction spend = am.pay (Address.fromSatoshiStyle (address), amount, true);
					System.out.println ("About to send " + printuBTC (amount) + " to " + address);
					...
					{
						System.out.println (out.getOutputAddress () + " " + printuBTC (out.getValue ()));
					}
					w.lock ();
				...
				else if ( answer.equals ("s") )
				{
					...
					System.out.println ("About to sweep " + printuBTC (alm.getBalance ()) + " to " + a);
					System.out.println ("inputs");
